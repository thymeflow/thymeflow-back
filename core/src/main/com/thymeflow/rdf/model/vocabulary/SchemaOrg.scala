...
object SchemaOrg {
  ...
  val CONTAINS_PLACE: IRI = SimpleValueFactory.getInstance().createIRI(NAMESPACE, "containsPlace")
  val CONTAINED_IN_PLACE: IRI = SimpleValueFactory.getInstance().createIRI(NAMESPACE, "containedInPlace")
  ...
  val ELEVATION: IRI = SimpleValueFactory.getInstance().createIRI(NAMESPACE, "elevation")
  ...
  val SENDER: IRI = SimpleValueFactory.getInstance().createIRI(NAMESPACE, "sender")
